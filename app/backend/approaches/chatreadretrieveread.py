...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "How does one clear a clogged nozzle?"},
        {"role": ASSISTANT, "content": "Show clogged nozzle clearing procedure"},
        {"role": USER, "content": "How do you rotate at mixing tube?"},
        {"role": ASSISTANT, "content": "Show mixing tube rotation instructions"},
    ]
        ...
        functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "search_query": {
                            "type": "string",
                            "description": "Query string to retrieve documents from azure search eg: 'Nozzle change'",
                        }
                    },
